 ...
 * @version 1.0.0
 *
 * @see http://www.jmic.de/img/jm-blowfish.zip
 * @todo 128-bit-block-size blowfish encrypt/decrypt
 * @example
 *        $blowfish = new blowfish();
 *         $key = 'This is key';
 *         $blowfish->keys($key);
 *         $plaintext = 'This is plain text';
 *         $cipher = $blowfish->blowfish_crypt($plaintext);
...
class Blowfish
{
    ...
    /**
     * Encryption mode: EBC: 0 CBC: 1
     *
     * @var int
     */
    public $encryptmode  = 1 ;
     ...
     *
     * @param int $hashcfg
     * @param int $encryptmode
     */
    function __construct($hashcfg=1, $encryptmode=1)
    {
    ...
    function keys($key)
    {
        ...
        {
            $v = $this->block_encrypt(array($v[0],$v[1]));
            $this->pbox[$i] = $v[0];
            $this->pbox[$i+1] = $v[1];
        }
    ...
    function encrypt($text)
    {
        ...
        for($i = 0; $i<count($text); $i+=2)
        {
            ...
            $cipher[] = $this->block_encrypt(array($text[$i], $text[$i+1]));
            $a++;
        }
